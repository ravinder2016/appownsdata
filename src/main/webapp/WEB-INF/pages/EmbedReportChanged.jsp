...
<%--		<section id="text-container" class="embed-container col-lg-4 col-md-4 col-sm-4 mb-5 ml-5 mt-5">
	...
	<script>
		...
		fetchPowerBIReports("${req.contextPath}/getembedinfo", function(data) {

		});

		function fetchPowerBIReports(url, callback) {
			let xhr = new XMLHttpRequest();
			xhr.onreadystatechange = function() {
				if (xhr.readyState == 4 && xhr.status == 200) {
					const embedData =JSON.parse(xhr.response);
					const embedReports = embedData.embedReports;
